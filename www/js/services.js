...
.factory('Transactions', function ($http, $rootScope, $stateParams, $q, lw) {
  ...
  return {
    ...
    balance: function(account){
      ...
      return $http.get(lw.uri + '/account?address='+account)
    },
    ...
    getNestedData: function(address) {
      ...
      return $http.get(lw.uri+'/log?address='+address).success(function(res) {
...
.factory('Accounts', function ($http, $rootScope, $stateParams, $q, $window, _, lw, blockapps, $ionicPlatform, ipfs_) { //$cordovaKeychain, $cordovaTouchID
  ...
  // var hex_address = "c7f6cd8f951298227792595b4b23551f3b6ccae71f0d99fba2f4a76864ea1f15";
  ...
  return {
    ...
    balance: function(){
      ...
      return $http.get(lw.uri + '/account?address='+getCurrentAddress())
    },
